<tr valign="top">
            ...
            <td class="forminp" id="package_box_collection">
                <table class="widefat wc_input_table sortable" cellspacing="0">
                    <thead>
                        <tr>
                            <th class="sort">&nbsp;</th>
                            <th><?php _e('Model Name', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                            <th><?php _e('Length', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                            <th><?php _e('Width', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                            <th><?php _e('Height', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                            <th><?php _e('Weight (LB)', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                            <th><?php _e('Max. Supported (LB)', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></th>
                        </tr>
                    </thead>
        ...
        ?>
                    ...
                    <tfoot>
                        <tr>
                            <th colspan="7"><a href="#" class="add button"><?php _e('+ Add package box', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></a> <a href="#" class="remove_rows button"><?php _e('Remove selected package box(es)', FLAGSHIP_SHIPPING_TEXT_DOMAIN);
        ?></a></th>
                        </tr>
                    </tfoot>
                </table>
