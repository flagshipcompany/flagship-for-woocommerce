...
class FlagShipWcShippingMethod extends \WC_Shipping_Method
{
    ...
    protected function get_instance_settings()
    {
        $instanceSettings = array(
            ...
            'flagship_insurance' => array(
                'title' => __('Add Insurance', FLAGSHIP_SHIPPING_TEXT_DOMAIN),
                'description' => __('If checked, all the shipments to this shipping zone will be insured', FLAGSHIP_SHIPPING_TEXT_DOMAIN),
                'type' => 'checkbox',
                'default' => 'no',
            ),
