...
class Menu_Helper {
    ...
    public function add_flagship_to_menu($items)
    {
        ...
        add_submenu_page(self::$menuItemUri, __( 'Shipment', 'flagship-for-woocommerce'), __( 'Shipment', 'flagship-for-woocommerce'), 'manage_options', self::$menuItemUri, array($this, 'load_flagship_shipment_page'));
        add_submenu_page(self::$menuItemUri, __( 'Manage shipment', 'flagship-for-woocommerce'), __( 'Manage shipment', 'flagship-for-woocommerce'), 'manage_options', 'flagship/manage', array($this, 'load_flagship_manage_shipment_page'));
        add_submenu_page(self::$menuItemUri, __( 'Package boxes', 'flagship-for-woocommerce'), __( 'Package boxes', 'flagship-for-woocommerce'), 'manage_options', self::$package_boxes_uri, array($this, 'list_boxes'));
    ...
    public function add_flagship_link()
    {
        ...
        $submenu[self::$menuItemUri][] = array(
            sprintf(
                ...
                __('Visit FlagShip site', 'flagship-for-woocommerce'),
            ),
            "manage_options",
            "flagship\/site",
            "Visit FlagShip site"
    ...
    public function add_settings_link()
    {
        ...
        $submenu[self::$menuItemUri][] = array(
            sprintf(
                '<a href="%s">%s </a>',
                $settingsUrl,
                __('Settings', 'flagship-for-woocommerce'),
            ),
            "manage_options",
            "flagship\/settings",
            "Settings"
